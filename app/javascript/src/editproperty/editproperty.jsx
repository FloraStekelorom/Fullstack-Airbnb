...
class Editproperty extends React.Component {
  ...
  render () {
    const { property, editable, propertyTitle, propertyDescription, propertyType, propertyCity, propertyCountry, propertyPrice,
    propertyGuests, propertyBedrooms, propertyBeds, propertyBaths, propertyWifi, propertyKitchen, propertyIron, propertyTv, propertyEssentials, propertyWasher, propertyHeating, propertyAir_conditioning, propertyBathtub, propertyParking, propertyMicrowave, propertyOven, propertyRefrigerator, propertyHair_dryer, propertyBalcony, propertySmoke_alarm, propertyFire_extinguisher } = this.state;
        ...
        <div className="container ">
          <div className="row">
            <div className="col-12">
              ...
              {!editable ?
                <div>
                  <p><b>Property Title:</b> {property.title} </p>
                  <p><b>Property Description:</b> {property.description} </p>
                  <p><b>Property City:</b> {property.city} </p>
                  <p><b>Property Country:</b> {property.country} </p>
                  <p><b>Property Property Type:</b> {property.property_type} </p>
                  <p><b>Property Price:</b> US$ {property.price_per_night} / night </p>
                  <p><b>Property Max Guests:</b> {property.max_guests} </p>
                  <p><b>Property Bedrooms:</b> {property.bedrooms} </p>
                  <p><b>Property Beds:</b> {property.beds} </p>
                  <p><b>Property Baths:</b> {property.baths} </p>
